...
export default function CtaBand() {
  return (
    <div style={{ position: 'relative', overflow: 'hidden', background: 'var(--ocean)', borderTop: '1px solid rgba(180,200,230,0.12)', borderBottom: '1px solid rgba(180,200,230,0.12)', padding: 'clamp(64px,8vw,96px) 0' }}>
      {/* Bulk carrier ship at sea - Pexels free photo */}
      <div style={{ position: 'absolute', inset: 0, backgroundImage: 'url(https://images.pexels.com/photos/1117210/pexels-photo-1117210.jpeg?auto=compress&cs=tinysrgb&w=1400)', backgroundSize: 'cover', backgroundPosition: 'center', opacity: 0.15 }}></div>
