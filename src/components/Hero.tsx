  ...
  return (
    <div style={{ position: 'relative', minHeight: '100svh', display: 'flex', alignItems: 'center', overflow: 'hidden', background: 'var(--deep)' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, maxWidth: '1200px', margin: '0 auto', padding: '110px 1.5rem 60px', width: '100%' }}>
        ...
        {/* Tagline: NOEMAGROUP big, Maritime Freight Solutions smaller below */}
        <div className="animate-fade-up delay-1" style={{ marginBottom: '32px' }}>
          ...
          <div style={{ paddingLeft: '50px' }}>
            <span style={{ fontFamily: 'var(--font-mono)', fontSize: '12px', fontWeight: 700, letterSpacing: '0.2em', color: 'var(--gold)', textTransform: 'uppercase' }}>
        ...
        <div className="animate-fade-up delay-4" style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '56px', maxWidth: '340px' }}>
          ...
          <Link href="/services" style={{ background: 'transparent', color: '#dce6f0', fontFamily: 'var(--font-mono)', fontSize: '13px', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', padding: '15px 28px', border: '1px solid rgba(180,200,230,0.3)', textDecoration: 'none', textAlign: 'center', display: 'block' }}>Request Freight Solution</Link>
          <Link href="/contact" style={{ background: 'transparent', color: '#dce6f0', fontFamily: 'var(--font-mono)', fontSize: '13px', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', padding: '15px 28px', border: '1px solid rgba(180,200,230,0.3)', textDecoration: 'none', textAlign: 'center', display: 'block' }}>Contact Commercial Desk</Link>
        </div>
        ...
        <div className="animate-fade-up delay-5" style={{ borderTop: '1px solid rgba(180,200,230,0.15)' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap' }}>
            {['Dry Bulk Transport','Port-to-Port Freight','Vessel Capacity','Voyage Coordination'].map(t => (
              <div key={t} style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--faint)', padding: '18px 20px 18px 0', marginRight: '20px', borderRight: '1px solid rgba(180,200,230,0.12)' }}>{t}</div>
            ))}
          </div>
        </div>
      </div>
