  ...
  return (
    <div style={{ position: 'relative', minHeight: '100svh', display: 'flex', alignItems: 'center', overflow: 'hidden', background: 'var(--deep)' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, maxWidth: '1200px', margin: '0 auto', padding: '110px 1.5rem 60px', width: '100%' }}>
        ...
        {/* Tagline — NOEMA yellow, GROUP white, Maritime Freight Solutions yellow, all bigger */}
        <div className="animate-fade-up delay-1" style={{ marginBottom: '32px', display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' as const }}>
          <span style={{ display: 'inline-block', width: '36px', height: '1px', background: 'var(--gold)', flexShrink: 0 }}></span>
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: '14px', fontWeight: 700, letterSpacing: '0.18em' }}>
            <span style={{ color: 'var(--gold)' }}>NOEMA</span>
            <span style={{ color: '#f0f4fa' }}>GROUP</span>
          </span>
          <span style={{ color: 'rgba(180,200,230,0.3)', fontFamily: 'var(--font-mono)', fontSize: '14px' }}>—</span>
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: '14px', fontWeight: 700, letterSpacing: '0.18em', color: 'var(--gold)' }}>
